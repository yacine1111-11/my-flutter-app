...
import '../screen/liste_demandes.dart';
import 'admin/listecompte (2).dart';
import 'admin/offres (2).dart';
import 'admin/parametre (4).dart';
import 'admin/renouvlement.dart';
import 'admin/statistique.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  String _currentPage = 'offers'; // Suivi de la page actuellement affichée
            ...
            child: ListView(
              ...
              children: [
                ...
                _buildSidebarItem(
                  ...
                  title: "Demandes depannages",
                  page: 'withdraw_list',
                ),
                _buildSidebarItem(
                  icon: Icons.verified_user,
                  title: "Assurance demande depannage ",
                  page: 'assurance_depannage',
                ),
                _buildSidebarItem(
                  icon: Icons.description,
                  title: "Renouvlement d'assurance",
                  page: 'assurance',
                ),
                _buildSidebarItem(
                  icon: Icons.sync_problem_rounded,
                  title: "List Reclamation",
                  page: 'compensation_requests',
                ),
                _buildSidebarItem(
                  icon: Icons.description,
  ...
  Widget _buildMainContent() {
    switch (_currentPage) {
      ...
      case 'compensation_requests':
        return DemandesAccidentScreen();
      case 'assurance_depannage':
